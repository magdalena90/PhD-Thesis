...
datTraits = datMeta %>% dplyr::select(Diagnosis, Brain_lobe, Sex, Age, PMI, RNAExtractionBatch) %>%
            dplyr::rename('Batch' = RNAExtractionBatch, 'Lobe' = Brain_lobe)
...
The highest correlations are found to diagnosis but there are also some other relatively high correlations.

Modules with a positive correlation to diagnosis tend to become to one of the batches sand modules with a negative correlation to the other batch.

```{r plot_heatmap, fig.width=10, fig.height=14, warning=FALSE, message=FALSE}
...
# There are some entries of the textMatrix that is not being rounded off properly, so I'll have to set it manually
textMatrix[9,1] = '0.53 (3e-314)'
textMatrix[44,1] = '-0.14 (9e-316)'
textMatrix[45,1] = '-0.14 (9e-244)'
textMatrix[86,1] = '-0.53 (9e-262)'
textMatrix[83,2] = '-0.12 (9e-270)'
textMatrix[51,2] = '0.15 (9e-297)'
textMatrix[45,2] = '-0.072 (9e-266)'
textMatrix[100,4] = '-0.14 (8e-236)'
textMatrix[92,4] = '-0.014 (9e-235)'
textMatrix[88,4] = '-0.097 (9e-301)'
textMatrix[14,4] = '0.17 (1e-320)'
textMatrix[53,6] = '0.023 (9e-250)'
textMatrix[66,6] = '0.24 (5e-316)'
textMatrix[83,6] = '0.08 (9e-322)'
...
There doesn’t seem to be a strong relation between these two metrics.
...
There is a positive relation between these two metrics; the higher the mean expression of the genes in a module, the higher the enrichment in SFARI Genes.

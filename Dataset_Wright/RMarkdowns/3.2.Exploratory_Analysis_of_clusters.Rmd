...
textMatrix[1,1] = '0.81 (9e-274)'
textMatrix[29,1] = '0.21 (9e-226)'
textMatrix[34,1] = '0.81 (3e-319)'
textMatrix[39,1] = '0.087 (9e-237)'
textMatrix[28,3] = '-0.095 (1e-311)'
textMatrix[33,3] = '0.1 (5e-323)'
textMatrix[93,3] = '-0.16 (9e-218)'
...
There are not enough DE genes in this dataset for this analysis
...
ggplotly(enrichment_data %>% ggplot(aes(MTcor, 1-pval_ORA, size=size)) + 
         ...
         xlab('Cluster-Diagnosis Correlation') + ylab('Enrichment in SFARI Genes') + 
...
mean_expr_by_module = data.frame(ID = rownames(datExpr), mean_expr = rowMeans(datExpr)) %>%
                      ...
                      group_by(Module) %>% summarise(mean_expr = mean(mean_expr))  %>% filter(mean_expr>0)
